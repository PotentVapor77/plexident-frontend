      ...
      {gruposRender.map((grupo, grupoIndex) => {
        ...
        return (
          <div 
            ...
            className="flex items-start gap-3 p-3 bg-white border border-slate-200 rounded-lg hover:border-brand-300 transition-colors"
          >
            <div className="flex-shrink-0 mt-0.5">
              <div className="h-6 w-6 rounded-full bg-brand-100 flex items-center justify-center">
                <span className="text-xs font-semibold text-brand-700">{grupoIndex + 1}</span>
              </div>
            </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-1">
                ...
                {tieneMultiplesSuperficies && (
                  <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-brand-50 text-brand-600 border border-brand-200">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  <div className="font-medium text-slate-800 text-sm flex-1">
                    {codigo && <span className="text-brand-600 font-mono mr-2">[{codigo}]</span>}
                    {nombre}
                  </div>
                  {estado && (
                ...
                {cargandoPlanes ? (
                  ...
                  <div className="space-y-3">
                    {planesDisponibles.map((plan) => (
                      <div
                        key={plan.id}
                        className="p-4 border border-slate-200 rounded-lg hover:border-brand-300 hover:bg-brand-50 cursor-pointer transition-all duration-200"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-brand-50 border border-brand-100 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-brand-600">DIAGNÓSTICOS</span>
                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-slate-200">
                        {sesion.notas && (
                          <div>
                            ...
                            <div className="bg-brand-50 p-3 rounded-lg border border-brand-100 text-sm text-slate-700">
                              {sesion.notas}
                            </div>
                          </div>
                        )}
