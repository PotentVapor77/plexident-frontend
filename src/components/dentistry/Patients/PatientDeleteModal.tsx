// dentist/PatientDeleteModal.tsx
import type { PatientDeleteModalProps } from "../../../types/IPatient";
import { Modal } from "../../ui/modal";



export function PatientDeleteModal({ isOpen, onClose, patient, onConfirm }: PatientDeleteModalProps) {
