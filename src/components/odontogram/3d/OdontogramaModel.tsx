...
export const OdontogramaModel = ({
  ...
  // ⚡ CLONAR la escena para evitar conflictos entre múltiples Canvas
  const { scene: originalScene } = useGLTF("/models/odontograma.glb") as any;
  const scene = useMemo(() => originalScene.clone(), [originalScene]);

  const { getDominantColorForTooth, isToothBlocked } = odontogramaDataHook;
  ...
  useEffect(() => {
    ...
    console.log("[Model] Re-painting teeth due to data change");
