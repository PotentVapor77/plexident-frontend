// src/components/familyBackground/modals/FamilyBackgroundDeleteModal.tsx
    ...
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-md p-6">
      <div className="flex flex-col">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          ¿Está seguro de que desea <strong>desactivar</strong> los antecedentes familiares de{' '}
