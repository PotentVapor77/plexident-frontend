// src/components/stomatognathicExam/modals/StomatognathicExamDeleteModal.tsx

import { useState } from "react";
import { useQuery } from "@tanstack/react-query";
import { getPacienteById } from "../../../../services/patient/patientService";
import type { IPacienteBasico, IStomatognathicExam } from "../../../../types/stomatognathicExam/IStomatognathicExam";
import type { IPaciente } from "../../../../types/patient/IPatient";
import { Modal } from "../../../ui/modal";

interface StomatognathicExamDeleteModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function StomatognathicExamDeleteModal({
  isOpen,
  onClose,
  exam,
  onDeleted,
  notify,
}: StomatognathicExamDeleteModalProps) {
  ...
  const getPacienteId = (): string | null => {
    ...
    if (typeof exam.paciente === "object" && exam.paciente !== null) {
      const pacienteBasico = exam.paciente as unknown as IPacienteBasico;
    ...
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-lg">
      <div className="p-6">
        ...
        <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
          ¿Está seguro de que desea eliminar el examen estomatognático registrado de{" "}
