...
export function PacienteTable({
  ...
  const { pacientes, pagination, loading, error } = usePacientes({
    page,
    page_size: pageSize,
    search,
  });
  ...
  const handleToggleStatusClick = (paciente: IPaciente) => {
    onToggleStatus?.(paciente);
  };
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end gap-2">
                      ...
                      <button
                        ...
                        title={paciente.activo ? "Desactivar" : "Reactivar"}
                      >
                        {paciente.activo ? (
                          <svg
                            className="w-5 h-5"
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M18.364 5.636L5.636 18.364M9 5h10M5 9v10"
                            />
                          </svg>
                        ) : (
                          <svg
      ...
      {pagination && pagination.total_pages > 1 && (
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-center px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
          <div className="text-sm text-gray-700 dark:text-gray-300">
            ...
            {pagination.count} pacientes totales)
          </div>
