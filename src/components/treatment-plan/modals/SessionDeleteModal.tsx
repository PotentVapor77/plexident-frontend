// src/components/odontogram/treatmentPlan/SessionDeleteModal.tsx
...
interface SessionDeleteModalProps {
  isOpen: boolean;
  onClose: () => void;
  sesion: SesionTratamientoListResponse;
  onConfirm: () => void;
  isDeleting: boolean;
}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="text-center">
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Esta acción eliminará de forma permanente la sesión de tratamiento seleccionada.{" "}
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm text-red-800 dark:text-red-200">
              <p>
                <span className="font-semibold">Número:</span> Sesión #{sesion.numero_sesion}
              </p>
              <p>
              ...
              <p>
                <span className="font-semibold">Estado:</span> {sesion.estado_display}
              </p>
              <p>
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
            <p className="text-xs text-amber-800 dark:text-amber-200">
              <strong>Nota:</strong> Se perderán todos los diagnósticos, procedimientos y 
              prescripciones registrados en esta sesión. Esta acción es irreversible.
            </p>
          </div>
        </div>
